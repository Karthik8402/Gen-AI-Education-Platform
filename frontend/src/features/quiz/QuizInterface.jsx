...
export default function QuizInterface() {
  ...
  const submitQuiz = async () => {
    ...
    const payload = {
      quizId,
      answers: answers.map((sel, i) => ({
        index: i,
        answer: sel != null ? questions[i].choices[sel] : '',
      })),
      // Include timing data
      timingData: {
  ...
  const TimerDisplay = ({ timeLeft, timerEnabled }) => {
    ...
    return (
      <div className="mb-6">
        ...
        <div className={`w-full rounded-full h-3 shadow-inner transition-colors duration-300 ${
          currentTheme === 'dark' ? 'bg-gray-700' : 'bg-gray-200'
        }`}>
          <div
            className={`h-3 rounded-full transition-all duration-1000 ${
              isVeryLowTime ? 'bg-gradient-to-r from-red-500 to-red-600' : 
      ...
      <div className={`min-h-screen transition-colors duration-300 ${
        ...
        <div className="max-w-4xl mx-auto py-12 px-6">
          <div className={`rounded-3xl border p-8 shadow-xl backdrop-blur-sm transition-colors duration-300 ${
            ...
            <div className={`mb-8 p-6 rounded-2xl border-2 transition-colors duration-300 ${
              currentTheme === 'dark'
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-6 py-4 border-2 rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 text-lg transition-all ${
                    currentTheme === 'dark'
            ...
            <div className="mb-8">
              ...
              <div className="px-2">
                ...
                <div className={`flex justify-between text-xs mt-2 px-1 transition-colors duration-300 ${
                  currentTheme === 'dark' ? 'text-gray-500' : 'text-gray-400'
                }`}>
            ...
            <div className={`mb-10 p-6 border-2 rounded-2xl transition-colors duration-300 ${
              currentTheme === 'dark'
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-8 w-14 items-center rounded-full transition-all duration-300 ${
                    timerEnabled ? 'bg-indigo-600 shadow-lg' : currentTheme === 'dark' ? 'bg-gray-600' : 'bg-gray-300'
                  }`}
                >
    ...
    return (
      <div className={`min-h-screen transition-colors duration-300 ${
        ...
        <div className="max-w-5xl mx-auto py-8 px-6">
          ...
          <div className={`rounded-2xl shadow-xl border p-8 mb-8 backdrop-blur-sm transition-colors duration-300 ${
            currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
          }`}>
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                onClick={resetQuiz}
                className={`flex items-center space-x-2 text-sm font-medium px-4 py-2 border rounded-lg transition-all ${
                  currentTheme === 'dark'
          ...
          <div className={`rounded-2xl shadow-xl border p-10 transition-colors duration-300 ${
            currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
          }`}>
            <div className="mb-8">
              ...
              <h2 className={`text-2xl font-semibold leading-relaxed mb-4 transition-colors duration-300 ${
                currentTheme === 'dark' ? 'text-gray-100' : 'text-gray-900'
              }`}>
                {question?.question}
              </h2>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span className={`text-lg font-medium flex-1 transition-colors duration-300 ${
            ...
            <div className="flex justify-between items-center">
              <button
                ...
                className={`flex items-center space-x-2 px-6 py-3 disabled:opacity-50 disabled:cursor-not-allowed border rounded-xl transition-all ${
                  currentTheme === 'dark'
                    ? 'text-gray-400 hover:text-gray-200 border-gray-600 hover:bg-gray-700'
