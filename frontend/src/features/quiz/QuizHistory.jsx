    ...
    return (
      <div className={`min-h-screen transition-colors duration-300 ${currentTheme === 'dark'
        ...
        <div className="max-w-6xl mx-auto py-12 px-6">
          <div className={`rounded-3xl border p-12 shadow-xl backdrop-blur-sm transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
            }`}>
            <div className="animate-pulse">
              <div className={`h-8 rounded-xl w-1/3 mb-6 ${currentTheme === 'dark' ? 'bg-gray-700' : 'bg-gray-200'
                }`}></div>
              <div className="space-y-4">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className={`h-20 rounded-xl ${currentTheme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'
                    }`}></div>
                ))}
              </div>
            </div>
        ...
        <div className={`rounded-3xl border shadow-xl backdrop-blur-sm overflow-hidden transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
          ...
          <div className="p-8">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h1 className={`text-3xl font-bold mb-2 flex items-center transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-100' : 'text-gray-900'
                  }`}>
                  <History className="w-8 h-8 text-indigo-600 mr-3" />
                  Quiz History
                </h1>
                <p className={`text-lg transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-300' : 'text-gray-600'
                  }`}>
            ...
            {totalAttempts > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className={`rounded-2xl p-6 border transition-colors duration-300 ${currentTheme === 'dark'
                    ? 'bg-gradient-to-r from-blue-900/30 to-indigo-900/30 border-blue-700'
                    : 'bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200'
                  }`}>
                  <div className="flex items-center justify-between">
                    <div>
                      <p className={`text-sm font-medium mb-1 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-blue-300' : 'text-blue-700'
                        }`}>Average Score</p>
                      <p className={`text-3xl font-bold transition-colors duration-300 ${currentTheme === 'dark' ? 'text-blue-200' : 'text-blue-900'
                        }`}>{averageScore}%</p>
                    </div>
                    <BarChart3 className={`w-8 h-8 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-blue-400' : 'text-blue-600'
                      }`} />
                  </div>
                </div>
                ...
                <div className={`rounded-2xl p-6 border transition-colors duration-300 ${currentTheme === 'dark'
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className={`text-sm font-medium mb-1 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-green-300' : 'text-green-700'
                        }`}>Best Score</p>
                      <p className={`text-3xl font-bold transition-colors duration-300 ${currentTheme === 'dark' ? 'text-green-200' : 'text-green-900'
                        }`}>{Math.round(bestScore)}%</p>
                    </div>
                    <Trophy className={`w-8 h-8 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-green-400' : 'text-green-600'
                      }`} />
                  </div>
                </div>
                ...
                <div className={`rounded-2xl p-6 border transition-colors duration-300 ${currentTheme === 'dark'
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className={`text-sm font-medium mb-1 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-purple-300' : 'text-purple-700'
                        }`}>Total Questions</p>
                      <p className={`text-3xl font-bold transition-colors duration-300 ${currentTheme === 'dark' ? 'text-purple-200' : 'text-purple-900'
                        }`}>
                        {attempts.reduce((sum, attempt) => sum + (attempt.score?.total || 0), 0)}
                      </p>
                    </div>
                    <Brain className={`w-8 h-8 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-purple-400' : 'text-purple-600'
                      }`} />
                  </div>
                </div>
                ...
                <div className={`rounded-2xl p-6 border transition-colors duration-300 ${currentTheme === 'dark'
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className={`text-sm font-medium mb-1 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-orange-300' : 'text-orange-700'
                        }`}>Trend</p>
                      <div className="flex items-center space-x-2">
                        {recentTrend === 'improving' ? (
                          <>
                            <TrendingUp className="w-6 h-6 text-green-600" />
                            <span className={`text-lg font-bold transition-colors duration-300 ${currentTheme === 'dark' ? 'text-green-200' : 'text-green-900'
                              }`}>Improving</span>
                          </>
                        ) : recentTrend === 'declining' ? (
                          <>
                            <TrendingDown className="w-6 h-6 text-red-600" />
                            <span className={`text-lg font-bold transition-colors duration-300 ${currentTheme === 'dark' ? 'text-red-200' : 'text-red-900'
                              }`}>Needs Focus</span>
                          </>
                        ) : (
                          <>
                            <Target className="w-6 h-6 text-blue-600" />
                            <span className={`text-lg font-bold transition-colors duration-300 ${currentTheme === 'dark' ? 'text-blue-200' : 'text-blue-900'
                              }`}>Stable</span>
                          </>
                        )}
                      </div>
            ...
            <div className={`rounded-2xl p-6 mb-8 border transition-colors duration-300 ${currentTheme === 'dark'
                ? 'bg-gray-700/50 border-gray-600'
                : 'bg-gray-50 border-gray-200'
              }`}>
              <div className="flex flex-wrap items-center gap-4">
                <div className="relative flex-1 min-w-64">
                  <Search className={`w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-500' : 'text-gray-400'
                    }`} />
                  <input
                    type="text"
                    ...
                    className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-300 ${currentTheme === 'dark'
                ...
                <select
                  ...
                  className={`px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors duration-300 ${currentTheme === 'dark'
        ...
        <div className={`rounded-3xl border shadow-xl backdrop-blur-sm overflow-hidden transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
          ...
          {filteredAttempts.length === 0 ? (
            <div className="p-16 text-center">
              <div className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'
                }`}>
                {attempts.length === 0 ? (
                  <History className={`w-10 h-10 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-500' : 'text-gray-400'
                    }`} />
                ) : (
                  <Search className={`w-10 h-10 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-500' : 'text-gray-400'
                    }`} />
                )}
              </div>
              ...
              <p className={`mb-8 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                }`}>
                {attempts.length === 0
            ...
            <div className={`divide-y transition-colors duration-300 ${currentTheme === 'dark' ? 'divide-gray-700' : 'divide-gray-100'
              }`}>
              {filteredAttempts.map((attempt, index) => {
                ...
                return (
                  <div
                    ...
                    className={`p-6 cursor-pointer transition-all duration-200 group ${currentTheme === 'dark'
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start space-x-4">
                          {/* Topic Icon */}
                          <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 transition-colors duration-300 ${currentTheme === 'dark'
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center flex-wrap gap-2 mb-2">
                              <h3 className={`text-lg font-semibold truncate transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-100' : 'text-gray-900'
                                }`}>
                                {attempt.topic || 'Unknown Topic'}
                              </h3>
                              <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${attempt.difficulty === 'beginner'
                                  ? currentTheme === 'dark'
                            ...
                            {/* Details */}
                            <div className={`flex items-center space-x-4 text-sm mb-2 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                              }`}>
                              ...
                              {(attempt.timingData?.totalTimeSpent || attempt.timing_data?.totalTimeSpent) && (
                                <span className="flex items-center">
                                  <Clock className="w-4 h-4 mr-1" />
                                  {Math.round((attempt.timingData?.totalTimeSpent || attempt.timing_data?.totalTimeSpent) / 60)}m
                                </span>
                              )}
                            </div>
                      ...
                      <div className="flex items-center space-x-6 ml-6">
                        ...
                        {/* View Details Button */}
                        <div className="flex items-center space-x-2">
                          <button className={`p-2 rounded-lg transition-all group-hover:text-indigo-600 ${currentTheme === 'dark'
                              ? 'text-gray-500 hover:text-indigo-400 hover:bg-indigo-900/20'
                              : 'text-gray-400 hover:text-indigo-600 hover:bg-indigo-50'
                            }`}>
                            <Eye className="w-5 h-5" />
                          </button>
                          <ChevronRight className={`w-5 h-5 transition-colors group-hover:text-indigo-600 ${currentTheme === 'dark' ? 'text-gray-500' : 'text-gray-400'
                            }`} />
                        </div>
                      </div>
                    </div>
          ...
          {/* Footer Actions */}
          {filteredAttempts.length > 0 && (
            <div className={`border-t p-6 transition-colors duration-300 ${currentTheme === 'dark'
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center space-x-4">
                  <button
                    ...
                    className={`inline-flex items-center px-6 py-3 border rounded-xl font-medium transition-all ${currentTheme === 'dark'
