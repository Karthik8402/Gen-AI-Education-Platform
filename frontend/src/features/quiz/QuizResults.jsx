...
export default function QuizResults() {
    ...
    return (
      <div className={`min-h-screen transition-colors duration-300 ${currentTheme === 'dark'
        ...
        <div className="max-w-4xl mx-auto py-12">
          <div className={`rounded-3xl border p-12 shadow-xl text-center backdrop-blur-sm transition-colors duration-300 ${currentTheme === 'dark'
            ...
            <h2 className={`text-xl font-semibold mb-2 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-100' : 'text-gray-900'
      ...
      <div className={`min-h-screen transition-colors duration-300 ${currentTheme === 'dark'
        ...
        <div className="max-w-4xl mx-auto py-12">
          <div className={`rounded-3xl border p-12 shadow-xl text-center backdrop-blur-sm transition-colors duration-300 ${currentTheme === 'dark'
            ...
            <h2 className={`text-2xl font-bold mb-4 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-100' : 'text-gray-900'
              }`}>Results Not Found</h2>
            <p className={`mb-8 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-300' : 'text-gray-600'
  ...
  const timingData = quizData?.timingData || result.timingData
    ...
    <div className={`min-h-screen transition-colors duration-300 ${currentTheme === 'dark'
      ...
      <div className="max-w-6xl mx-auto py-8 px-6 space-y-8">
        ...
        <div className={`rounded-3xl border shadow-xl backdrop-blur-sm overflow-hidden transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
          ...
          <div className="p-10">
            <div className="text-center">
              ...
              <div className={`inline-flex items-center justify-center w-24 h-24 rounded-full mb-6 ${isExcellent ? 'bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30 text-green-600' :
              ...
              <div className="mb-6">
                <h2 className={`text-xl mb-2 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-200' : 'text-gray-700'
                  }`}>{topic}</h2>
                <div className={`flex items-center justify-center space-x-4 text-sm transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-300' : 'text-gray-600'
                  }`}>
              ...
              <div className="text-8xl font-bold mb-4">
                ...
                <span className={`transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-500' : 'text-gray-300'
                  }`}> / </span>
                <span className={`transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                  }`}>{score.total}</span>
              </div>

              <div className={`text-3xl font-bold mb-6 ${isExcellent ? 'text-green-600' :
                isGood ? 'text-blue-600' :
                  'text-yellow-600'
                }`}>
                {percentage}%
              ...
              <div className={`inline-flex items-center px-8 py-3 rounded-full text-lg font-bold shadow-lg ${isExcellent
              ...
              <div className="mt-6">
                <button
                  ...
                  className={`inline-flex items-center px-4 py-2 border rounded-lg transition-all ${currentTheme === 'dark'
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Correct Answers */}
          <div className={`rounded-2xl border p-6 shadow-lg transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
            }`}>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                <CheckCircle className="w-8 h-8 text-green-600 mr-3" />
                <div>
                  <h3 className={`font-semibold transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-100' : 'text-gray-900'
                    }`}>Correct</h3>
            ...
            <div className={`w-full rounded-full h-2 transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-700' : 'bg-gray-200'
              }`}>
              <div
          ...
          <div className={`rounded-2xl border p-6 shadow-lg transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <span className={`text-lg font-bold capitalize px-3 py-1 rounded-full ${assessedLevel === 'expert' ? 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300' :
        ...
        {/* Performance Insights */}
        <div className={`rounded-2xl border p-8 shadow-lg transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
          }`}>
          <h2 className={`text-xl font-bold mb-6 flex items-center transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-100' : 'text-gray-900'
            }`}>
          ...
          <div className="space-y-4">
            {performanceInsights.map((insight, index) => (
              <div key={index} className={`flex items-start p-4 rounded-xl border transition-colors duration-300 ${currentTheme === 'dark'
                ...
                <p className={`flex-1 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-200' : 'text-gray-800'
                  }`}>{insight.slice(2)}</p>
              </div>
            ))}
          </div>
        ...
        <div className={`rounded-2xl border p-8 shadow-lg transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
          ...
          <div className="space-y-6">
            {details.map((d, i) => (
              <div key={i} className={`rounded-xl border-2 p-6 transition-all ${d.isCorrect
                ? currentTheme === 'dark'
                ...
                <div className="flex items-start justify-between mb-4">
                  <h3 className={`font-semibold text-lg flex items-center transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-100' : 'text-gray-900'
                    }`}>
                    <span className={`px-3 py-1 rounded-full text-sm font-bold mr-3 transition-colors duration-300 ${currentTheme === 'dark'
                  ...
                  <span className={`inline-flex items-center px-3 py-2 rounded-full text-sm font-bold ${d.isCorrect
                ...
                <div className="space-y-3">
                  {!d.isCorrect && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className={`border rounded-lg p-4 transition-colors duration-300 ${currentTheme === 'dark'
                        ? 'bg-red-900/20 border-red-700'
                        : 'bg-red-100 border-red-200'
                        }`}>
                        <p className={`text-sm font-medium mb-1 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-red-300' : 'text-red-800'
                          }`}>Your Answer:</p>
                        <p className={`font-semibold transition-colors duration-300 ${currentTheme === 'dark' ? 'text-red-200' : 'text-red-700'
                          }`}>
                      ...
                      <div className={`border rounded-lg p-4 transition-colors duration-300 ${currentTheme === 'dark'
                        ...
                        <p className={`text-sm font-medium mb-1 transition-colors duration-300 ${currentTheme === 'dark' ? 'text-green-300' : 'text-green-800'
                          }`}>Correct Answer:</p>
                        <p className={`font-semibold transition-colors duration-300 ${currentTheme === 'dark' ? 'text-green-200' : 'text-green-700'
                          }`}>{d.correctAnswer}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {d.explanation && (
                    <div className={`border rounded-lg p-4 transition-colors duration-300 ${currentTheme === 'dark'
                      ...
                      <p className={`text-sm font-medium mb-1 flex items-center transition-colors duration-300 ${currentTheme === 'dark' ? 'text-blue-300' : 'text-blue-800'
                        }`}>
                        <Brain className="w-4 h-4 mr-1" />
                        Explanation:
                      </p>
                      <p className={`transition-colors duration-300 ${currentTheme === 'dark' ? 'text-blue-200' : 'text-blue-700'
                        }`}>{d.explanation}</p>
                    </div>
                  )}
                </div>
        ...
        <div className={`rounded-2xl border p-8 shadow-lg transition-colors duration-300 ${currentTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
          ...
          <h3 className={`text-lg font-semibold mb-6 text-center transition-colors duration-300 ${currentTheme === 'dark' ? 'text-gray-100' : 'text-gray-900'
            }`}>What's Next?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <button
              ...
              className={`flex items-center justify-center px-8 py-4 border-2 rounded-xl font-semibold transition-all duration-200 ${currentTheme === 'dark'
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-600 flex justify-center space-x-4">
            <button
              ...
              className={`inline-flex items-center px-6 py-3 font-medium transition-all ${currentTheme === 'dark'
